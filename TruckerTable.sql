...
-- ----------------------------
INSERT INTO `trucks_delivering` VALUES ('johndoe@example.com', '2015-11-16 00:00:00', 8, 'Flatbed', 'CLEVELAND', 'OH', 'MILFORD', 'CT', 517, 5000, 'Broker');
INSERT INTO `trucks_delivering` VALUES ('janedoe@example.com', '2015-11-16 00:00:00', 8, 'FLAT OR STEP DECK', 'MARIETTA', 'OH', 'CEDAR RAOIDS', 'IA', 689, 11000, 'Broker');
INSERT INTO `trucks_delivering` VALUES ('jimsmith@example.com', '2015-11-16 00:00:00', 7, 'VAN', 'BUCYRUS', 'OH', 'DANVILLE', 'IL', 309, NULL, 'Truck');
INSERT INTO `trucks_delivering` VALUES ('johndoe@example.com', '2023-04-19 10:00:00', 8, 'Refrigerated', 'Boston', 'MA', 'Dallas', 'TX', 1900, 9000, 'Full Truckload');
INSERT INTO `trucks_delivering` VALUES ('janedoe@example.com', '2023-04-20 08:00:00', 7, 'Dry Van', 'Seattle', 'WA', 'Orlando', 'FL', 3000, 12000, 'Full Truckload');
INSERT INTO `trucks_delivering` VALUES ('jimsmith@example.com', '2023-04-21 12:00:00', 9, 'Flatbed', 'Portland', 'OR', 'New York', 'NY', 4000, 15000, 'Full Truckload');
INSERT INTO `trucks_delivering` VALUES ('johnsmith@example.com', '2023-04-22 15:00:00', 12, 'Dry Van', 'Chicago', 'IL', 'Los Angeles', 'CA', 2000, 10000, 'Full Truckload');
INSERT INTO `trucks_delivering` VALUES ('janesmith@example.com', '2023-04-23 09:00:00', 13, 'Flatbed', 'Miami', 'FL', 'Houston', 'TX', 1200, 8000, 'Full Truckload');
INSERT INTO `trucks_delivering` VALUES ('johntaylor@example.com', '2023-04-24 14:00:00', 8, 'Refrigerated', 'Atlanta', 'GA', 'San Francisco', 'CA', 3000, 12000, 'Full Truckload');
